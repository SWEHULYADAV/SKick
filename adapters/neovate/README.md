# Neovate Adapter — ECOSYSTEM-VERIFIED, RECHECK FIRST-PARTY DOCS
...
2. Confirm the active runtime really is **Neovate**.
...
- **Project/local destinations:** `.neovate/skills/skick/`
- **User/personal destinations:** `~/.neovate/skills/skick/`
