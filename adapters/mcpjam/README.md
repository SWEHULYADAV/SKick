# MCPJam Adapter — ECOSYSTEM-VERIFIED, RECHECK FIRST-PARTY DOCS
...
2. Confirm the active runtime really is **MCPJam**.
...
- **Project/local destinations:** `.mcpjam/skills/skick/`
- **User/personal destinations:** `~/.mcpjam/skills/skick/`
...
https://docs.mcpjam.com/inspector/skills
