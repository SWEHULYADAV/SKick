# Windsurf / Cascade Adapter — VERIFIED

Windsurf Cascade supports Skills as folders with `SKILL.md` and supporting resources. Skills use progressive disclosure and can be invoked automatically or explicitly with an `@` mention.
...
You can also create/import through Cascade's Customizations > Skills UI where available.

## Call SKick

Use a matching task or explicitly mention the skill, for example `@skick review this architecture` or `Use SKick to research this dependency`.

## Verify

1. Open Cascade Customizations > Skills and confirm SKick is listed.
2. Invoke it on a low-risk task.
3. Confirm full skill instructions/resources were loaded before reporting success.
...
- **Surfaces covered:** Windsurf IDE, Cascade
...
- **Project/local destinations:** `.windsurf/skills/skick/`
- **User/personal destinations:** `~/.codeium/windsurf/skills/skick/`
...
1. Open Cascade Customizations > Skills and confirm SKick is listed.
2. Use @SKick or a matching prompt and confirm its instructions/resources load.
