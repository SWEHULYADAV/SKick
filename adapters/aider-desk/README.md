# AiderDesk Adapter — ECOSYSTEM-VERIFIED, RECHECK FIRST-PARTY DOCS
...
2. Confirm the active runtime really is **AiderDesk**.
...
- **Project/local destinations:** `.aider-desk/skills/skick/`
- **User/personal destinations:** `~/.aider-desk/skills/skick/`
