...
Kimi plugins can bundle Skills, agents, MCP servers, hooks and session-start instructions. Keep v1.1 as a plain portable Skill unless Kimi-specific plugin functionality is required.
