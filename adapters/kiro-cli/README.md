# Kiro Adapter — VERIFIED

SKick uses the current first-party/evidence-backed Skill contract for **Kiro**. Preserve the complete SKick directory and verify discovery in the active runtime; file presence alone is not a runtime test.
...
Use .kiro/skills/skick for workspace scope or ~/.kiro/skills/skick for global scope. Skills work across current Kiro IDE/CLI/Web/Mobile surfaces with scope differences; GitHub import requires a Skill subdirectory or SKILL.md URL rather than an arbitrary repository root.
...
- **Project/local destinations:** `.kiro/skills/skick/`
- **User/personal destinations:** `~/.kiro/skills/skick/`
