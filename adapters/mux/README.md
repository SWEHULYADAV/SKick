# Mux Adapter — ECOSYSTEM-VERIFIED, RECHECK FIRST-PARTY DOCS
...
2. Confirm the active runtime really is **Mux**.
...
1. Use Mux Skill listing/read tooling and confirm SKick is visible.
2. Run a low-risk matching task and confirm supporting files resolve.
