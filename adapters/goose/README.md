# Goose Adapter — ECOSYSTEM-VERIFIED, RECHECK FIRST-PARTY DOCS
...
- `~/.config/goose/skills/skick/`

## Safe install

1. Read `../../START_HERE.md` and `../../docs/WARNINGS.md`.
2. Confirm the active runtime really is **Goose**.
...
1. Run `goose skills list` or `/skills` and confirm SKick is listed.
2. Invoke a low-risk matching task and confirm SKick supporting files can be read.
